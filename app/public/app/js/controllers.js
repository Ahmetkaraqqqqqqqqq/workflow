...
function AppCtrl ($rootScope, $scope, $location, Task, User){
    ...
    $scope.addUser = function(params){
		User.add($scope.form, function(user){
			...
			$scope.user = user;
			$scope.imagem_gravatar = $scope.get_gravatar;
		  	$location.path('/');
		});
	}
	...
	$scope.getUser = function(params){
		...
		User.getUser($scope.form, function(data){
			console.log("getUser usuario = ", data.user);
	...
	$scope.get_gravatar = function(params){
		console.log("-------------------chamou get_gravatar------------------");
		
		var imagem;
		User.getUser($scope.form, function(data){
			if(data != null && data.user != null){
				var email = data.user.email;
				console.log("get_gravatar = ", email);
